...
export class AppComponent {
	...
	constructor(private zone: NgZone, private matIconRegistry: MatIconRegistry, domSanitizer: DomSanitizer) {
		let icons = 'Filled';
		this.matIconRegistry.addSvgIconSet(
			domSanitizer.bypassSecurityTrustResourceUrl(`/assets/material-icons-${icons}.svg`)
		);

		this.matIconRegistry.addSvgIcon('github', domSanitizer.bypassSecurityTrustResourceUrl('/assets/github.svg'));
